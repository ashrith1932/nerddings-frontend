...
export default function ProfilePage({ username }: { username: string }) {
  ...
  return (
    <div className="profile-page">
      ...
      <div style={{ fontFamily: "'Space Grotesk', sans-serif" }}><ProfileSectionTabs username={username} profileUser={user} profileStats={data.stats} profileAffiliations={affiliations} /></div>
