...
import ProjectDetailSurface from "@/components/pages/Projects/ProjectDetailPage";
import YourNerddingsRoute from "@/components/pages/YourNerddings/YourNerddingsPage";

export default function RouteVisualRuntime() {
  ...
  return <>
    <style>{`html{scrollbar-gutter:stable}.page-content{min-height:100vh;position:relative}.profile-post-detail-slot:empty{display:none!important}.page-content-route-overlay{position:absolute;inset:0;z-index:90;background:var(--paper,#f9f7f2);overflow:auto;padding:4px 0 50px}.page-content-project-overlay{position:absolute;inset:0;z-index:95;background:rgba(25,20,16,.22);display:flex;align-items:flex-start;justify-content:center;padding:18px;overflow:auto}.page-content-project-panel{width:min(100%,1120px);min-height:calc(100% - 36px);background:#fffdf9;border:1px solid #ded7cf;border-radius:14px;box-shadow:0 24px 70px rgba(31,27,24,.16);overflow:auto;position:relative}.page-content-project-close{position:absolute;right:14px;top:14px;z-index:10;width:34px;height:34px;border:1px solid #ddd6cc;border-radius:50%;background:#fffdf9;color:#746b64;display:grid;place-items:center;cursor:pointer}`}</style>
